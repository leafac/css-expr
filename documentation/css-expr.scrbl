...
@margin-note{See CSS-expressions in action on my @hyperlink["https://www.leafac.com"]{personal website} (@hyperlink["https://git.leafac.com/www.leafac.com/"]{source}). It also uses @hyperlink["https://docs.racket-lang.org/pollen-component"]{Pollen Component}.}
